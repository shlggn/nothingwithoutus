...
const Navbar = () => {
  ...
  return (
    <nav className={`z-50 ${!isHome ? 'hero-gradient' : 'bg-transparent'}`}>
      <div className="max-w-[100rem] mx-auto px-6 h-28 flex items-center justify-between">
        <a href="/" className="flex items-center gap-2 font-display text-lg font-semibold tracking-tight text-foreground">
          <img src={nothingwihtoutuslogo} alt="Nothing Without Us Logo" className="h-24 flex items-center justify-center" />
          {/* Nothing Without Us */}
        </a>
